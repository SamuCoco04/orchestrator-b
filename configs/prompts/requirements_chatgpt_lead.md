...
Return a SINGLE JSON object (no markdown, no commentary) with this wrapper shape: { "REVIEW_JSON": {"accepted":[],"rejected":[],"issues":[],"missing":[],"rationale":[]}, "REQUIREMENTS_JSON": {"requirements":[],"assumptions":[],"constraints":[]} }
